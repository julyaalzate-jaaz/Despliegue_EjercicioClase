...
if uploaded_file is not None:
    try:
        ...
        st.write(df[['ID', 'Predicted_Aprobo_RF']].head())
        ...
        st.write(df[['ID', 'Predicted_Aprobo_LR']].head())
        ...
        st.write(df[['ID', 'Predicted_Aprobo_MLP']].head())

        st.subheader("Resultados Completos:")
        st.write(df[['ID', 'Examen_admisión', 'Felder', 'Predicted_Aprobo_RF', 'Predicted_Aprobo_LR', 'Predicted_Aprobo_MLP']])
